...
const WorkerSignup = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    localStorage.setItem('workerSignupData', JSON.stringify(formData));
      ...
      <div className="max-w-md mx-auto">
        <Card>
          <CardHeader className="text-center">
            <CardTitle className="text-2xl font-bold text-gray-800">Worker Registration</CardTitle>
            <p className="text-gray-600">Join as a skilled professional</p>
          </CardHeader>
          <CardContent>
